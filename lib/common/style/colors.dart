...
class MaterialTheme {
  ...
  ThemeData theme(ColorScheme colorScheme) => ThemeData(
        ...
        brightness: colorScheme.brightness, // 主题亮度
        colorScheme: colorScheme, // 主题色
        textTheme: textTheme.apply(
          bodyColor: colorScheme.onSurface, // 文本颜色
          displayColor: colorScheme.onSurface, // 文本颜色
        ),
        scaffoldBackgroundColor: colorScheme.surface, // 背景颜色
        canvasColor: colorScheme.surface, // 背景颜色
      );
